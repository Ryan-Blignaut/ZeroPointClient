...
import jchroma.devices.DeviceInfos;
import jchroma.devices.GUIDStruct;
import jchroma.effects.*;
...
public class JChroma
{
    ...
    private JChroma()
    {
        ...
        wrapper = Native.loadLibrary(libName, ChromaLib.class);
    }
     ...
     *
     * @throws JChromaException If there is any error while initialisation
     */
    public void init()
    {
     ...
     *
     * @throws JChromaException If there is any error while freeing
     */
    public void free()
    {
     ...
     * @throws JChromaException If the parameters of the effect are invalid or the effect is not supported
     */
     ...
     *
     * @param deviceID    The device to query
     * @param deviceInfos The object to store the infos in
     */
