...
public class CustomChromaLink extends MousepadEffect implements ChromaEffect1D
{
     ...
     *
     * @param colors The colors to assign to each key (in row/column order)
     */
    ...
    @Override public MousepadEffectType getType()
    {
        return MousepadEffectType.CUSTOM;
    }

    @Override public Structure createParameter()
    {
        return struct;
    }
     ...
     *
     * @param colors The colors to assign (row/column)
     */
