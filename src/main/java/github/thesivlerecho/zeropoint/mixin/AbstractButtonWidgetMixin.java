...
public abstract class AbstractButtonWidgetMixin extends DrawableHelper implements Drawable, Element
{

	@Shadow
	@Final
	public static Identifier WIDGETS_LOCATION;
	private final Identifier newButtonID = new Identifier(ZeroPointClient.MOD_ID, "textures/ui/button.png");
	private final Identifier newButtonIDHover = new Identifier(ZeroPointClient.MOD_ID, "textures/ui/button-hover.png");
	@Shadow
	public int x;
	@Shadow
	public int y;
	...
	@Shadow
	protected abstract void renderBg(MatrixStack matrices, MinecraftClient client, int mouseX, int mouseY);
