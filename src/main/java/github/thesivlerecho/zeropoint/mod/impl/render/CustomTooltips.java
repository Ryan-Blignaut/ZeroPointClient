...
public class CustomTooltips extends ClientMod
{
...
//		event.callbackInfo().cancel();
		...
		if (!components.isEmpty())
		{
			...
			drawTooltipRectangle(matrices, new Component2d(tooltipX, tooltipY, tooltipWidth, tooltipHeight).setColour(Color.PINK.getRGB()));
//			System.out.println("test");
	...
	public static void drawTooltipRectangle(MatrixStack matrixStack, Component2d component2d)
	{
		...
		component2d.setColour(Color.RED.getRGB());
//		DrawingUtil.drawRectWithShader(component2d, 3, matrixStack);
