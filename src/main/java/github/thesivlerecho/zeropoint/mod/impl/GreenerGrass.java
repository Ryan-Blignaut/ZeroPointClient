...
{
	private static final List<Block> GRASS = ImmutableList.of(Blocks.LARGE_FERN, Blocks.FERN, Blocks.TALL_GRASS, Blocks.GRASS_BLOCK, Blocks.GRASS, Blocks.POTTED_FERN, Blocks.SUGAR_CANE, Blocks.AZALEA, Blocks.FLOWERING_AZALEA);
	private static final List<Block> LEAVES = ImmutableList.of(Blocks.OAK_LEAVES, Blocks.SPRUCE_LEAVES, Blocks.BIRCH_LEAVES, Blocks.ACACIA_LEAVES, Blocks.DARK_OAK_LEAVES, Blocks.JUNGLE_LEAVES, Blocks.AZALEA_LEAVES, Blocks.FLOWERING_AZALEA_LEAVES, Blocks.VINE);
