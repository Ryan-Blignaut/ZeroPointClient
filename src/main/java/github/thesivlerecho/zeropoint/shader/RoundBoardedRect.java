...
public class RoundBoardedRect extends Shader
{
	public static RoundBoardedRect INST = new RoundBoardedRect("rectV.vert", "rectO.frag");

	public RoundBoardedRect(String vertFile, String fragFile)
	{
